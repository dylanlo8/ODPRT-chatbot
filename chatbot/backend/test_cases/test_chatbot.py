...
inputs = ["""I would like to transfer data from my collaborator for my research project, what agreement do I need?""",
...
ground_truth = ["""For incoming data transfer (e.g. NUS is receiving data from collaborator), please contact Office of Legal Affairs (OLA) at olasec@nus.edu.sg.
...
for i in range(len(inputs)):
    response = chatbot.query_workflow(user_query=inputs[i])
    print(response)
    context = vector_db.hybrid_search(inputs[i])
...
#     input="I would like to transfer data from my collaborator for my research project, what agreement do I need?",
#     actual_output="""
#         For transferring data from your collaborator for your research project, you need to contact the Office of Legal Affairs (OLA) at olasec@nus.edu.sg for the appropriate agreement regarding the incoming data transfer.
#     """,
#     expected_output="""
...
#     #                    """]      
#     retrieval_context=[vector_db.hybrid_search(input)]
# )

# test_case_2 = LLMTestCase(
#     input="What is the process for signing research agreements negotiated by IEP?",
#     actual_output="""
#         The process for signing research agreements negotiated by IEP involves the following steps:
#         Upon finalization of the research agreement, the assigned IEP case officer will seek NUS management approval.
#         This approval is in accordance with the NUS Policy of Approving and Signing Authority (NUS PASA) before the agreement is signed.
#     """,
#     expected_output="""
#         Upon finalization of research agreement and prior to signing, the assigned IEP case officer will seek NUS management approval in accordance with NUS Policy of Approving and Signing Authority (NUS PASA).
#     """,
#     retrieval_context=["The NUS Office of the Deputy President (Research & Technology) (ODPRT) oversees research compliance, integrity, grant administration, strategic initiatives, industry engagement, and research communications at NUS."]      
# )
